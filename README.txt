Requirements and Design and Test.
...
- $ export GOOGLE_APPLICATION_CREDENTIALS="<enter your path here>/private_key.json"
- Dependencies
- $ pip install --upgrade google-cloud-translate

Run script examples

# Don't need to specifiy a language we can just default to Spanish
